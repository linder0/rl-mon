...
const IterationView = dynamic(() => import("@/components/iteration/IterationView"), {
  ssr: false,
  loading: () => (
...
export function IterationClient({
  label,
  initialRun = null,
}: {
  label: string;
  ...
  return <IterationView label={label} initialRun={initialRun} />;
}
